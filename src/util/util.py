...
from src.util.definitions_sql import SQL_SENTENCE_SAVE, SQL_ALL_TERM_SEARCH_SEL
...
import requests
from src.util.search_engines import query_bing, query_flickr, query_wikipedia
from src.util.sqlite_helper import SQLiteHelper, HorusDB
import string
import unicodedata
import re
import langdetect
