...
SQL_TEXT_CLASS_SEL   = """SELECT id, result_seq, result_title, result_description, result_title_en, 
                                 result_description_en, processed, 
...
SQL_TEXT_CLASS_UPD   = """UPDATE HORUS_SEARCH_RESULT_TEXT SET processed = 1, 
                           text_1_klass_prob = %s, text_2_klass_prob = %s, text_0_klass_ovr = %s,
                           text_1_klass_cnn = %s, text_2_klass_cnn = %s, text_3_klass_cnn = %s, text_4_klass_cnn = %s, 
                           text_5_klass_cnn = %s,
