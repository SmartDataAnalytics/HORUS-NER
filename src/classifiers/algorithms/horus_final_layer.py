...
config = HorusConfig()
#file1reader = csv.reader(open(config.dir_output + "experiments/ritter/EXP_000/out_exp000_1.csv"), delimiter=",")
...
samplefile = config.dir_output + "experiments/EXP_001/wnut16.horus.conll"
...
#    le = joblib.load(config.dir_encoders + "encoder_nltk.pkl")
#elif config.models_pos_tag_lib == 2:
#    le = joblib.load(config.dir_encoders + "encoder_stanford.pkl")
#elif config.models_pos_tag_lib == 3:
#    le = joblib.load(config.dir_encoders + "encoder_tweetnlp.pkl")

le = joblib.load(config.dir_encoders + "_encoder_pos.pkl")
for x in features:
...
config = HorusConfig()
#features_file = open(config.dir_output + 'features_dt_wnut16.csv', 'wb')
#wr = csv.writer(features_file) #quoting=csv.QUOTE_ALL
#wr.writerows(features)

#target_file = open(config.dir_output + 'features_dt_wnut16_Y.csv', 'wb')
