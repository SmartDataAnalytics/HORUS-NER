...
from src.classifiers.util.inception import dataset_utils
...
DATA_DIR = config.root_dir_tensorflow
...
def create_readable_names_for_imagenet_labels():
  ...
  synset_url = '{}/imagenet_lsvrc_2015_synsets.txt'.format(DATA_DIR)
  synset_to_human_url = '{}/imagenet_metadata.txt'.format(DATA_DIR)
