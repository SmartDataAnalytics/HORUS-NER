...
FEATURES_HORUS_BASIC_TX = [INDEX_TOT_RESULTS_TX, INDEX_TOT_TX_LOC, INDEX_TOT_TX_ORG, INDEX_TOT_TX_PER, INDEX_TOT_ERR_TRANS, INDEX_DIST_TX_I, INDEX_NR_RESULTS_SE_TX, INDEX_MAX_KLASS_PREDICT_TX]
...
FEATURES_HORUS_BASIC_CV = [INDEX_TOT_IMG, INDEX_TOT_CV_LOC, INDEX_TOT_CV_ORG, INDEX_TOT_CV_PER, INDEX_DIST_CV_I, INDEX_PL_CV_I, INDEX_NR_RESULTS_SE_IMG, INDEX_MAX_KLASS_PREDICT_CV]
...
FEATURES_HORUS_TX = FEATURES_HORUS_BASIC_TX + FEATURES_HORUS_CNN_TX + FEATURES_HORUS_EMB_TX + FEATURES_HORUS_STATS_TX
