...
STANDARD_FEAT = 60
STANDARD_FEAT_WORD = 15

'''
STANDARD FEATURES
'''
FEATURES_STANDARD = range(HORUS_TOT_FEATURES+1, (HORUS_TOT_FEATURES+1 + STANDARD_FEAT)) # 145 - 85:144
FEATURES_STANDARD_WORD = range((HORUS_TOT_FEATURES+1 + STANDARD_FEAT), (HORUS_TOT_FEATURES+1 + STANDARD_FEAT + STANDARD_FEAT_WORD)) # 145+15=160 - 144:160

FEATURES_STANDARD_BROWN_64M_c320 = FEATURES_STANDARD_WORD
FEATURES_STANDARD_BROWN_64M_c320.extend([max(FEATURES_STANDARD_WORD) + 1]) #161

FEATURES_STANDARD_BROWN_64M_c640 = FEATURES_STANDARD_WORD
FEATURES_STANDARD_BROWN_64M_c640.extend([max(FEATURES_STANDARD_WORD) + 2]) #162

FEATURES_STANDARD_BROWN_500M_c1000 = FEATURES_STANDARD_WORD
FEATURES_STANDARD_BROWN_500M_c1000.extend([max(FEATURES_STANDARD_WORD) + 3]) #163

FEATURES_STANDARD_BROWN_BEST = [] #to be evaluated
'''
HORUS FEATURES
'''
