...
'''
FEATURES_HORUS_BASIC_TX_BEST_STANDARD = FEATURES_HORUS_BASIC_TX + FEATURES_STANDARD_BEST
FEATURES_HORUS_CNN_TX_BEST_STANDARD = FEATURES_HORUS_CNN_TX + FEATURES_STANDARD_BEST
FEATURES_HORUS_BASIC_CV_BEST_STANDARD = FEATURES_HORUS_BASIC_CV + FEATURES_STANDARD_BEST
FEATURES_HORUS_CNN_CV_BEST_STANDARD = FEATURES_HORUS_CNN_CV + FEATURES_STANDARD_BEST
FEATURES_HORUS_EMB_TX_BEST_STANDARD = FEATURES_HORUS_EMB_TX + FEATURES_STANDARD_BEST
FEATURES_HORUS_STATS_TX_BEST_STANDARD = FEATURES_HORUS_STATS_TX + FEATURES_STANDARD_BEST
FEATURES_HORUS_TX_BEST_STANDARD = FEATURES_HORUS_TX + FEATURES_STANDARD_BEST
FEATURES_HORUS_TX_EMB_BEST_STANDARD = FEATURES_HORUS_TX_EMB + FEATURES_STANDARD_BEST
FEATURES_HORUS_CV_BEST_STANDARD = FEATURES_HORUS_CV + FEATURES_STANDARD_BEST
FEATURES_HORUS_BASIC_AND_CNN_BEST_STANDARD = FEATURES_HORUS_BASIC_AND_CNN + FEATURES_STANDARD_BEST
FEATURES_HORUS_BEST_STANDARD = FEATURES_HORUS + FEATURES_STANDARD_BEST