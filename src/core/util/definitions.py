...
'''
FEATURES_STANDARD = \
    range(HORUS_TOT_FEATURES + 1, (HORUS_TOT_FEATURES + 1 + STANDARD_FEAT_BASIC_LEN)) # 145 - 85:144
FEATURES_STANDARD_WORD = \
    range((HORUS_TOT_FEATURES + 1 + STANDARD_FEAT_BASIC_LEN),
          (HORUS_TOT_FEATURES + 1 + STANDARD_FEAT_BASIC_LEN + STANDARD_FEAT_WORD_LEN)) # 145+15=160 - 144:160

FEATURES_STANDARD_BROWN_64M_c320 = range((HORUS_TOT_FEATURES + 1 + STANDARD_FEAT_BASIC_LEN + STANDARD_FEAT_WORD_LEN),
                                         (HORUS_TOT_FEATURES + 1 + STANDARD_FEAT_BASIC_LEN + STANDARD_FEAT_WORD_LEN) + 5)

FEATURES_STANDARD_BROWN_64M_c640 = range((HORUS_TOT_FEATURES + 1 + STANDARD_FEAT_BASIC_LEN + STANDARD_FEAT_WORD_LEN),
                                         (HORUS_TOT_FEATURES + 1 + STANDARD_FEAT_BASIC_LEN + STANDARD_FEAT_WORD_LEN) + 5)

FEATURES_STANDARD_BROWN_500M_c1000 = range((HORUS_TOT_FEATURES + 1 + STANDARD_FEAT_BASIC_LEN + STANDARD_FEAT_WORD_LEN),
                                         (HORUS_TOT_FEATURES + 1 + STANDARD_FEAT_BASIC_LEN + STANDARD_FEAT_WORD_LEN) + 5)
