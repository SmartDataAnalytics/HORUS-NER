...
#ret = horus.annotate(None, config.dataset_path + "wnut/2015.conll.freebase", 1, "experiments/ritter/EXP_001/out_exp002_wnut15_tweetNLP", "csv", 'wnut2015')
...
ret = horus.annotate(None, config.dataset_path + "wnut/2016.conn.freebase.ascii.txt", 1, "experiments/ritter/EXP_001/out_exp003_wnut16_tweetNLP_2", "csv", 'wnut2016')
print "done!"