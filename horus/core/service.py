...
import horus.core.object_detection.cnn
from horus.core.object_detection.cnn import CNN
from horus.core.object_detection.sift import SIFT
...
from horus.core.text_classification.bow_tfidf import BowTfidf
from horus.core.text_classification.topic_modeling import TopicModeling
from horus.core.translation.bingtranslation import BingTranslator
from horus.core.util import path_leaf
...
class Core(object):
    ...
    def annotate_text(self, text):
        ...
        try:
            ...
            if text is not None:
                ...
                self.horus_matrix = self.convert_sentence_to_horus_matrix(sent_tokenize_list)
            else:
    ...
    def convert_sentence_to_horus_matrix(self, sentences):
        '''
                ...
                for ifeat in filesimg:
                    if ifeat[2] == 1: # processed
                        ...
                        if self.config.object_detection_type in (-1,0):
                            ...
                            image = self.preprocess_image(ifeat[0])
                            # ----- face recognition -----
