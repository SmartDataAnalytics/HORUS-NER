...
convertHORUStoCoNLL("/Users/esteves/Github/horus-models/output/experiments/EXP_do_tokenization/test.csv",
                    [3,4], "/Users/esteves/Github/horus-models/output/conversion/test-ok.csv")
